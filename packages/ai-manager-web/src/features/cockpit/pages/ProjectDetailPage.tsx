...
import { Card, CardHeader, CardContent, Button, Badge, Tabs, TabsList, TabsTrigger, TabsContent } from '@/shared/ui';
import {
  Folder,
  ArrowLeft,
  Database,
...
import { NavRoute } from '@/shared/components';
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              >
                <div className="flex flex-col gap-2">
                  ...
                  <h4 className="text-sm font-bold text-foreground mt-1">Context Cockpit</h4>
                  <p className="text-xs text-muted-foreground">
                    Inspect function call graphs, query callers, database touches, and architecture bundles.
                  </p>
                </div>
                <div className="flex items-center gap-1 text-xs text-emerald-400 font-medium mt-4">
                  Open Cockpit <ExternalLink className="size-3" />
                </div>
              </Card>
