...
import { Card, CardHeader, CardTitle, CardContent, Button, Badge, Select, SelectTrigger, SelectValue, SelectContent, SelectItem } from '@/shared/ui';
import {
  GitCommitHorizontal,
  FolderOpen,
  Folder,
...
import { BranchFlagBadge } from '../components/BranchFlagBadge';
import { CodeViewerPane } from '../components/CodeViewerPane';
import { MergeConflictStudio } from '../components/MergeConflictStudio';
import { BranchHealthBoard } from '../components/BranchHealthBoard';
import { HierarchicalFileTree } from '../components/HierarchicalFileTree';
      ...
      <div className="flex flex-col gap-5 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col gap-1">
            <div className="flex items-center gap-3 flex-wrap">
              ...
              <BranchFlagBadge
                ...
                flag={currentFlag}
                onUpdateFlag={(status: 'green' | 'red' | 'problem' | 'neutral', note?: string) => updateBranchFlag(currentBranch, status, note)}
                align="left"
              />
            </div>
        ...
        {activeTab === 'health' && (
          <BranchHealthBoard
            ...
            onSelectBranch={(b: string) => {
              selectBranch(b);
              setActiveTab('inspector');
            }}
            onOpenMergeStudio={(b: string) => {
              selectBranch(b);
