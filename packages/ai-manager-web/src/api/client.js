...
var ApiClient = /** @class */ (function () {
    ...
    ApiClient.post = function (url, body) {
        return __awaiter(this, void 0, void 0, function () {
            var res, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ApiClient.put = function (url, body) {
        return __awaiter(this, void 0, void 0, function () {
            var res, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        data = _a.sent();
                        if (!res.ok)
                            throw new Error(data.error || 'API PUT failed');
                        return [2 /*return*/, data];
                }
            });
        });
